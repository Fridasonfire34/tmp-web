                      ...
                      >
                        ...
                        >
                          <List component="div" disablePadding>
                            ...
                            <ListItemButton
                              sx={{ pl: 4, color: '#187d91' }}
                              onClick={() => handleExport(week.week)}
                            >
                              <ListItemIcon sx={{ color: '#187d91' }}>
                                <DownloadICon />
                              </ListItemIcon>
                              <ListItemText primary="Descargar esta semana" />
                            </ListItemButton>
                            <ListItemButton
                              sx={{ pl: 4, color: 'red' }}
                              onClick={() => {
                            ...
                            >
                              ...
                              <ListItemText primary="Eliminar esta semana" />
                            </ListItemButton>
                          </List>
                        </Collapse>
                      </List>
